            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-xs-6">
                                <h5>Редактирование страницы "{{ $article->title }}"</h5>
                            </div>
                    ...
                    <div class="panel-body">
                        <form role="form" method="post" action="{{ route('admin.post.article.edit') }}" class="form-horizontal">
                            <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input
                                        ...
                                        type="text"
                                        class="form-control"
                                        value="{{ Request::old('title') ? Request::old('title') : $article->title }}"
                                    >
                                </div>
                            </div>
                            <div class="form-group {{ $errors->has('alias') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input
                                        ...
                                        type="text"
                                        class="form-control"
                                        value="{{ Request::old('alias') ? Request::old('alias') : $article->alias }}"
                                        @if($article->alias == 'public'||
                                            $article->alias == 'articles'||
                                            $article->alias == 'reviews'||
                                            $article->alias == 'contacts')
                                            readonly
                                        @endif
                                    >
                            ...
                            <div class="form-group {{ $errors->has('body') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="body" id="body" class="form-control" rows="10">{{ Request::old('body') ? Request::old('body') : $article->body }}</textarea>
                                </div>
                            </div>
                                    ...
                                    <div class="checkbox">
                                        <label>
                                            <input
                                                ...
                                                name="public"
                                                value="checkbox"
                                                {{ Request::old('public') ? 'checked' : $article->public ? 'checked' : '' }}
                                                @if($article->alias == 'public')
                            ...
                            <div class="form-group {{ $errors->has('meta_title') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text"
                                           ...
                                           id="meta_title"
                                           class="form-control"
                                           value="{{ Request::old('meta_title') ? Request::old('meta_title') : $article->meta_title }}">
                                </div>
                            </div>
                            <div class="form-group {{ $errors->has('meta_keywords') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <input type="text"
                                           ...
                                           id="meta_keywords"
                                           class="form-control"
                                           value="{{ Request::old('meta_keywords') ? Request::old('meta_keywords') : $article->meta_keywords }}">
                                </div>
                            </div>
