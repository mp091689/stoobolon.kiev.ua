...
return [
    ...
    */
    'custom'               => [
        'pass' => [
            'accepted' => 'Вы ввели неверный пароль.',
            'required' => 'Поле Пароль обязательно для заполнения.',
        ],
        'newpass' => [
            'required' => 'Поле Новый пароль обязательно для заполнения.',
            'min' => 'Количество символов в поле Новый пароль должно быть не менее :min.',
            'confirmed' => 'Поле Новый пароль не совпадает с подтверждением.',
        ],
        'title' => [
            'required' => 'Поле Название обязательно для заполнения.',
            'max' => 'Количество символов в поле Название должно быть не более :max.',
        ],
        'alias' => [
            'unique' => 'Такое значение поля Алиас уже существует.',
            'regex' => 'Поле Алиас имеет ошибочный формат.',
        ],
        'body' => [
            'required' => 'Основное поле обязательно для заполнения.',
        ],
        'author' => [
            'required' => 'Поле Имя обязательно для заполнения.',
            'max' => 'Количество символов в поле Имя должно быть не более :max.',
        ],
        'phone' => [
            'required' => 'Поле Телефон обязательно для заполнения.',
            'regex' => 'Поле Телефон имеет ошибочный формат.',
        ],
        'email' => [
            'required' => 'Поле Телефон обязательно для заполнения.',
            'email' => 'Поле Почта должно быть действительным электронным адресом.',
        ],
        'sort' => [
            'required' => 'Поле Сортировка обязательно для заполнения.',
            'unique' => 'Такое значение поля Сортировка уже существует.',
        ],
    ],
    /*
    |--------------------------------------------------------------------------
